...
### ⚒ Project Demo:
####  For Project Demo Follow the Link: https://multi-form-react.netlify.app/

### 🕵️‍♂️ Project Details:
####  This project is based on primarily on React TypeScript as well as uses other libraries too. In this app, you can use multi-step form!

### ⚙ Technical Details:
#### In this project, React with TypeScript is used for the project. Other Libraries used includes Material-UI, TypeScript, FontAwesome, Formik and Yup.
...
<p align="center">
  <a href="https://multi-form-react.netlify.app/">
